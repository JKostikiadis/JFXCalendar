...
public class CalendarSchedulerView extends StackPane {
	...
	private void initToolBar() {
		...
		Label dateLabel = new Label("September 2018");
		...
		todayButton.setOnAction(e -> {
			...
			// TODO : Add navigation of the main calendar

			// Change the label
			dateLabel.setText(MONTHS[currentDay.getMonthValue()] + " " + currentDay.getYear());
		});
